...
var gDocTable = new Array(
   ...
   new hrefList("slide0057.htm", 1, 5),
   new hrefList("slide0061.htm", 1, 6),
   new hrefList("slide0068.htm", 1, 7),
   ...
   new hrefList("slide0064.htm", 1, 12),
   new hrefList("slide0066.htm", 1, 13),
   new hrefList("slide0067.htm", 1, 14),
   new hrefList("slide0069.htm", 1, 15),
   new hrefList("slide0011.htm", 1, 16),
   new hrefList("slide0058.htm", 1, 17),
   new hrefList("slide0055.htm", 1, 18),
   new hrefList("slide0056.htm", 1, 19),
   new hrefList("slide0081.htm", 1, 20),
   new hrefList("slide0083.htm", 1, 21),
   new hrefList("slide0073.htm", 1, 22),
   new hrefList("slide0074.htm", 1, 23),
   new hrefList("slide0075.htm", 1, 24),
   new hrefList("slide0082.htm", 1, 25),
   new hrefList("slide0077.htm", 1, 26),
   new hrefList("slide0079.htm", 1, 27),
   new hrefList("slide0080.htm", 1, 28),
   new hrefList("slide0084.htm", 1, 29),
   new hrefList("slide0085.htm", 1, 30)
);
