...
var gDocTable = new Array(
   new hrefList("slide0257.htm", 1, 1),
   new hrefList("slide0266.htm", 1, 2),
   new hrefList("slide0293.htm", 1, 3),
   new hrefList("slide0317.htm", 1, 4),
   new hrefList("slide0268.htm", 1, 5),
   new hrefList("slide0303.htm", 1, 6),
   new hrefList("slide0315.htm", 1, 7),
   new hrefList("slide0269.htm", 1, 8),
   new hrefList("slide0270.htm", 1, 9),
   new hrefList("slide0271.htm", 1, 10),
   new hrefList("slide0273.htm", 1, 11),
   new hrefList("slide0294.htm", 1, 12),
   new hrefList("slide0295.htm", 1, 13),
   new hrefList("slide0292.htm", 1, 14),
   new hrefList("slide0320.htm", 1, 15),
   new hrefList("slide0318.htm", 1, 16),
   new hrefList("slide0319.htm", 1, 17),
   new hrefList("slide0323.htm", 1, 18),
   new hrefList("slide0301.htm", 1, 19),
   new hrefList("slide0276.htm", 1, 20),
   new hrefList("slide0277.htm", 1, 21),
   new hrefList("slide0280.htm", 1, 22),
   new hrefList("slide0281.htm", 1, 23),
   new hrefList("slide0286.htm", 1, 24),
   new hrefList("slide0321.htm", 1, 25),
   new hrefList("slide0282.htm", 1, 26),
   new hrefList("slide0324.htm", 1, 27),
   new hrefList("slide0325.htm", 1, 28),
   new hrefList("slide0302.htm", 1, 29),
   new hrefList("slide0285.htm", 1, 30)
);
