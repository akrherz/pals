...
def enter_db(ticks, quest, type, optiona, optionb, optionc, optiond, optione, optionf, answer, cor_comments, wro_comments):
	mydb.query("UPDATE "+table_str+" set question = '"+quest+"' , type = '"+type+"', optiona = '"+optiona+"', optionb = '"+optionb+"' , optionc = '"+optionc+"' , optiond = '"+optiond+"' , optione = '"+optione+"',optionf = '"+optionf+"', answer = '"+answer+"' , correct = '"+cor_comments+"',  wrong = '"+wro_comments+"' WHERE className = '"+className+"' and validTime = '"+ticks+"' ")
