...
#	print '<a href="/cgi-bin/campbell/hist/req_data.py?start_year='+yeer+'&end_year='+yeer+'&start_day='+start_day+'&end_month='+end_month+'&start_month='+start_month+'&end_day='+end_day+'&db=campbell_daily&data_type=c90">Click me for the Raw Data</a>'
