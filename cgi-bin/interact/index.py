...
#This script provides the framework for PALS Interactive
#Daryl Herzmann 7/13/98

from pgext import * 
from cgi import * 
import os, sys, regsub, re, style, c2w
...
def titler(bla):
	...
	print '<input type="hidden" name="user" value="'+user+'">'
	print '<table><tr><th align="right">Name the file for future reference:'
        print '<td><input type="text" name="title"><tr><th colspan=2 align="center">'
