...
def win_types():
	print '<TABLE><TR><TD align="left">'
        print '<INPUT TYPE=radio NAME="S" VALUE="S"> Moderately heavy snowfall (max. storm total amount in state is 6-12")<BR>'
        print '<INPUT TYPE=radio NAME="S" VALUE="T"> Extreme snowfall (max. storm total amount in state exceeds 12")<BR>'
