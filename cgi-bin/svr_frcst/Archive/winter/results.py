...
def Main():
	...
	key = form["key"][0]
	answers = admindb.query("SELECT h,r,t,state,etime from sessions_417 WHERE key = '"+str(key)+"' ").getresult()
	...
	print '<a href="http://www.pals.iastate.edu/mt417/">MT 417 Forecasting Excercise</a><BR>'
	print '</TD></TR>'
