...
def mk_data_link2(file, thumbnail, string_txt, i, hour_time):
	if os.path.isfile('/home/httpd/html/'+file):
		print '<a href="'+picturepy+'?file='+file+'"> '+hour_time+'</a><BR>'
	else:
		print "Missing"

def mk_data_link(file, thumbnail, string_txt):
	if os.path.isfile('/home/httpd/html/'+file):
		print '<a href="'+picturepy+'?file='+file+'">'+string_txt+'</a><BR>'
...
def mk_data(gmt_tuple):
	...
	print '<TR><TH></TH><TH>Current:</TH><TH>- 1 hr:</TH><TH>- 2 hrs:</TH><TH>- 3 hrs:</TH></TR>'
	print '<TR>'
