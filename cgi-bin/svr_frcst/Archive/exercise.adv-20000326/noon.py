...
def instructions():
	print """
	<P>Once you have successfully submitted your forecast, you will be given the data for the rest of the case in the same format as the  
	mornings. So you can experience the developement of severe weather for the remainder of the day.  At the end of the day, you will be given
	your score and an explanation of the day's severe weather.<BR>
	"""
...
def Main():
	...
	svrFrcst.svrTop(secs_tuple, secs)
        mk_help()
	...
	if case_num[0] == "s":
		print '<TR><TH bgcolor="#EEEEEE">Select a Time Period:</TH></TR>'
		print '<TR><TD align="CENTER">'
		times()
		print '</TD></TR>'
