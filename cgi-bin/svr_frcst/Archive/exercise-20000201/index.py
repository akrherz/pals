...
def Main():
	...
	print """
	<TABLE align="CENTER" bgcolor="black" cellpadding="2" border="0">
        <TR WIDTH="100%">
		<TD>
		<TABLE bgcolor="#EEEEEE" border="0" cellpadding="2" width="100%">
		<TR>
			<TD>
			<font color="blue" size="4" face="ARIAL"><B>Introduction:</B></font></TD>
		</TR>
		<TR>
			<TD bgcolor="white">
			This is an excerise in forecasting severe weather.  You will be given weather data for 6 hours into the forecast and then you  will be asked to make a
