...
def grade_winter(state, six_guess, twelve_guess, freeze_guess, case_num):
...
def Main():
	...
	if case_num[0] == "s":
		...
		six_pts, twelve_pts, freeze_pts = 0,0,0
		if state_pts > 0:
			six_txt, twelve_txt, freeze_txt, six_pts, twelve_pts, freeze_pts = grade_winter(state, six_guess, twelve_guess, freeze_guess, case_num)
