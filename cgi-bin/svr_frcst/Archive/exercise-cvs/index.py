...
def Main():
	...
	print """This is an exerise in forecasting severe weather.  You will be given weather data for 6 hours into the forecast and
then you  will be asked to make a decision on what you believe will happen.  Here is a look at the <a
href="/svr_frcst/images/noonView.gif">forecasting page</a> you will encounter at 18z.  A few things you may want to keep an eye on in
order to make an accurate forecast are:  the speed of the system to see how fast or slow it is moving, moisture supply out of the
Gulf of Mexico to fuel storms, and any type of gradient(s) that exist (tempertatre, dew point, wind). At the end of this forecasting
period, you will then be given your results.<BR><BR>"""
