...
def Main(interval, case_num, secs, key, refer):
	...
	special = mydb.query("SELECT ticks, question, type, optiona, optionb, optionc, optiond, optione, optionf, optiong, optionh  from spec_417 WHERE ticks = '"+str(secs)+"' ").getresult()
