...
def Main():
	...
	insert = mydb.query("DELETE from intanswers WHERE casenum = '"+caseNum+"' and intval = '"+question_num+"'  ")
	insert = mydb.query("INSERT into intanswers(casenum, intval, answer, correct, wrong) VALUES ('"+caseNum+"','"+question_num+"','"+answer+"', '"+cor_comments+"','"+wro_comments+"') ")
