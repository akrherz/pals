...
def add_entry(ticks):
	test = mydb.query("SELECT * from questions_417 WHERE ticks = '"+str(ticks)+"' ").getresult()
	if len(test) == 0:
		entry = mydb.query("INSERT into questions_417 VALUES('"+str(ticks)+"') ")
