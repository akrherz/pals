...
def enter_db(ticks, quest, type, optiona, optionb, optionc, optiond, optione, optionf, optiong, optionh, answer, cor_comments, wro_comments):
	verify = mydb.query("UPDATE "+table_str+" set question = '"+quest+"' , type = '"+type+"', optiona = '"+optiona+"', optionb = '"+optionb+"' , optionc = '"+optionc+"' , optiond = '"+optiond+"' , optione = '"+optione+"',optionf = '"+optionf+"',optiong = '"+optiong+"',optionh = '"+optionh+"',answer = '"+answer+"' , cor_comments = '"+cor_comments+"',  wro_comments = '"+wro_comments+"' WHERE ticks = '"+ticks+"' ")
...
def Main():
	...
	ticks = str(ticks)
	enter_db(ticks, quest, type, optiona, optionb, optionc, optiond, optione, optionf, optiong, optionh, answer, cor_comments, wro_comments)
