...
def enter_db(ticks, quest, type, optiona, optionb, optionc, optiond,  optione, optionf, optiong, optionh, answer, cor_comments, wro_comments, link):
	verify = mydb.query("insert into "+table_str+" VALUES ('"+ticks+"', '"+quest+"' , '"+type+"', '"+optiona+"', '"+optionb+"', '"+optionc+"','"+optiond+"', '"+optione+"','"+optionf+"' , '"+optiong+"' ,'"+optionh+"' , '"+answer+"', '"+cor_comments+"' , '"+wro_comments+"' , '"+link+"') ")
